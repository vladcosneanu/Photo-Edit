...
public class BrightnessControllersFragment extends Fragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = (ViewGroup) inflater.inflate(R.layout.fragment_brightness, container, false);
        ...
        valueTextView.setText(getString(R.string.value_percent, value - SEEK_BAR_OFFSET));
